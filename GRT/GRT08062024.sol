...
contract GRT is ERC20Decimals, Burnable, StuckRecover, GRT_PAY_Protocol {
    ...
    uint256 private constant TOTAL_SUPPLY = 200000000000 * (10**18);
    ...
    {
        _mint(__GRT_target, TOTAL_SUPPLY);
        transferOwnership(__GRT_target);
    }
